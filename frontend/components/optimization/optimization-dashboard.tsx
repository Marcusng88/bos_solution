...
import { Lightbulb, Target, DollarSign, RefreshCw, AlertTriangle, Search } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Competitor-driven AI recommendations to outperform your rivals</p>
        </div>
        <Button>
