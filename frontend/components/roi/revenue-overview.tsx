  ...
  useEffect(() => {
    ...
    const fetchRevenueData = async () => {
      try {
        ...
        const trendsResponse = await roiApi.revenueTrends(user.id, range)
        ...
        const sourceResponse = await roiApi.revenueBySource(user.id, range)
          ...
          <CardHeader>
            ...
            <CardDescription>
              {range === "7d" ? "Last 7 days revenue by platform" :
               ...
               range === "1y" ? "Last year revenue by platform" :
